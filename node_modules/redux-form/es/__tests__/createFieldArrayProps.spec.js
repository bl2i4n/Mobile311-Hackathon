...
var describeCreateFieldProps = function describeCreateFieldProps(name, structure, expect) {
  ...
  describe(name, function () {
    ...
    it('should provide errors', function () {
      expect(createFieldArrayProps.apply(undefined, defaultProps.concat([{ syncError: 'Sync Error' }])).fields.error).toBe('Sync Error');
      expect(createFieldArrayProps.apply(undefined, defaultProps.concat([{ syncError: 'Sync Error' }])).fields.valid).toBe(false);
      expect(createFieldArrayProps.apply(undefined, defaultProps.concat([{ syncError: 'Sync Error' }])).fields.invalid).toBe(true);
      expect(createFieldArrayProps.apply(undefined, defaultProps.concat([{
